...
<body>
<center><h3>Delivery Requests</h3></center>
...
<div align="center">
<display:table id="data" uid="row" name="${requestScope.requestedBooksList}" pagesize="5" requestURI="requestedBooks">
		...
		<display:column >
			<a class="btn btn-info" href='approveDeleiveryRequest?requestId=<s:property value="%{#attr.row.requestId}"/>'><s:property value="%{getText('global.approve')}"/></a>
		</display:column>
