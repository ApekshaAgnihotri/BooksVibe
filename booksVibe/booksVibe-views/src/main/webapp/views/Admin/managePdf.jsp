...
<br/><br/>
		...
		<s:form action="masterGetParameterMethod" label="PDF Generation" id="form2" theme="bootstrap"  cssClass="form-inline">
...
<s:if test="%{#request.pdfList.size!= 0}"> 
	<s:url action="masterGeneratePdf" var="masterGeneratePdf" />
	<a href="<s:property value="#masterGeneratePdf"/>"><s:property value="%{getText('global.generatePdf')}"/></a>
	<br />
