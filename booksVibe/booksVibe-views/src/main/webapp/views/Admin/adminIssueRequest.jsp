...
<body>
	...
	<div align="center">
		<display:table id="data" uid="row"
			name="${requestScope.requestedBooksList}" pagesize="5"
			requestURI="requestedBooks">
			...
			<display:column property="bookTitle" title="Title" sortable="true" />
			<display:column property="requestDate" titleKey="global.requestDate"
				sortable="true" />
			<display:column property="requestStatus" titleKey="global.requestStatus"
				sortable="true" />
			...
			<display:column>
				<a class="btn btn-info"
					href='masterApproveDeleiveryRequest?requestId=<s:property value="%{#attr.row.requestId}"/>'><s:property value="%{getText('global.approve')}"/></a>
			</display:column>
